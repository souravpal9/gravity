...
const ProfessionalDashboard = () => {
    ...
    const teams = [
        { id: 'engineering', name: 'Engineering', channels: ['general', 'frontend', 'backend', 'release-notes'] },
        { id: 'design', name: 'Design Studio', channels: ['general', 'ui-kit', 'research'] },
        { id: 'marketing', name: 'Growth', channels: ['general', 'campaigns', 'content'] },
    ];
    ...
    const displayMessages = messages.length
        ...
        : [
            {
                id: 'seed-1',
                text: 'Morning team! Today’s focus is stabilizing the release branch and closing open QA items.',
                time: '9:05 AM',
                user: { id: 'lead-1', name: 'Priya Shah' }
            },
            {
                id: 'seed-2',
                text: 'Frontend: I pushed the new nav polish. Please sanity check on mobile.',
                time: '9:12 AM',
                user: { id: 'dev-1', name: 'Marcus Reid' }
            },
            {
                id: 'seed-3',
                text: 'Backend: rate-limit fix is live; monitoring error rate now.',
                time: '9:18 AM',
                user: { id: 'dev-2', name: 'Evelyn Torres' }
            }
        ];
