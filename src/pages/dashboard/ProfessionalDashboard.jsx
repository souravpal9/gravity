                    ...
                    <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6">
                        {messages.map((msg) => {
                            ...
                            <div key={msg.id} className="group flex gap-4">
                                <div className={`w-10 h-10 rounded-lg flex-shrink-0 ${isMe ? 'bg-primary-600' : 'bg-gradient-to-br from-primary-500 to-purple-600'}`} />
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-baseline gap-2 mb-1">
                                        <span className="font-bold text-slate-800 dark:text-slate-200 truncate">{msg.user?.name || 'Guest'}</span>
